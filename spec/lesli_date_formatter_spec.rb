...
RSpec.describe LesliDate::Formatter, type: :model do

    before(:all) do
        @settings = LesliDate::Formatter.new.instance_variable_get(:@settings)
    end

    describe "from Time.current object" do 

        it "should parse a new date from Time.current object" do 
            datetime = LesliDate::Formatter.new(Time.current).date
            expect(LesliDate::Formatter.new(datetime.get).date.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date.to_s).to eql(datetime.to_s)
        end

        it "should parse a new time from Time.current object" do 
            datetime = LesliDate::Formatter.new(Time.current).time
            expect(LesliDate::Formatter.new(datetime.get).time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time from Time.current object" do 
            datetime = LesliDate::Formatter.new(Time.current).date_time
            expect(LesliDate::Formatter.new(datetime.get).date_time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_words from Time.current object" do 
            datetime = LesliDate::Formatter.new(Time.current).date_words
            expect(LesliDate::Formatter.new(datetime.get).date_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_words.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time_words Time.current object" do 
            datetime = LesliDate::Formatter.new(Time.current).date_time_words
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.to_s).to eql(datetime.to_s)
        end
    ...
    describe "from iso8601 string" do 
        ...
        it "should parse a new date from iso8601 string" do 
            datetime = LesliDate::Formatter.new("1990-09-11T05:05:05+00:00").date
            expect(LesliDate::Formatter.new(datetime.get).date.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date.to_s).to eql(datetime.to_s)
        end

        it "should parse a new time from iso8601 string" do 
            datetime = LesliDate::Formatter.new("1990-09-11T05:05:05+00:00").time
            expect(LesliDate::Formatter.new(datetime.get).time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time from iso8601 string" do 
            datetime = LesliDate::Formatter.new("1990-09-11T05:05:05+00:00").date_time
            expect(LesliDate::Formatter.new(datetime.get).date_time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_words from iso8601 string" do 
            datetime = LesliDate::Formatter.new("1990-09-11T05:05:05+00:00").date_words
            expect(LesliDate::Formatter.new(datetime.get).date_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_words.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time_words from iso8601 string" do 
            datetime = LesliDate::Formatter.new("1990-09-11T05:05:05+00:00").date_time_words
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.to_s).to eql(datetime.to_s)
        end
    ...
    describe "from database datetime column format" do 
        ...
        it "should parse a new date from database datetime column format" do 
            datetime = LesliDate::Formatter.new("1990-09-11 05:05:00").date
            expect(LesliDate::Formatter.new(datetime.get).date.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date.to_s).to eql(datetime.to_s)
        end

        it "should parse a new time from database datetime column format" do 
            datetime = LesliDate::Formatter.new("1990-09-11 05:05:00").time
            expect(LesliDate::Formatter.new(datetime.get).time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time from database datetime column format" do 
            datetime = LesliDate::Formatter.new("1990-09-11 05:05:00").date_time
            expect(LesliDate::Formatter.new(datetime.get).date_time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_words from database datetime column format" do 
            datetime = LesliDate::Formatter.new("1990-09-11 05:05:00").date_words
            expect(LesliDate::Formatter.new(datetime.get).date_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_words.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time_words from database datetime column format" do 
            datetime = LesliDate::Formatter.new("1990-09-11 05:05:00").date_time_words
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.to_s).to eql(datetime.to_s)
        end
    ...
    describe "from string with custom format" do 
        ...
        it "should parse a new date from string with custom format" do 
            datetime = LesliDate::Formatter.new("1990/09/11 05:05", "%Y/%m/%d %H:%M").date
            expect(LesliDate::Formatter.new(datetime.get).date.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date.to_s).to eql(datetime.to_s)
        end

        it "should parse a new time from string with custom format" do 
            datetime = LesliDate::Formatter.new("1990/09/11 05:05", "%Y/%m/%d %H:%M").time
            expect(LesliDate::Formatter.new(datetime.get).time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time from string with custom format" do 
            datetime = LesliDate::Formatter.new("1990/09/11 05:05", "%Y/%m/%d %H:%M").date_time
            expect(LesliDate::Formatter.new(datetime.get).date_time.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_words from string with custom format" do 
            datetime = LesliDate::Formatter.new("1990/09/11 05:05", "%Y/%m/%d %H:%M").date_words
            expect(LesliDate::Formatter.new(datetime.get).date_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_words.to_s).to eql(datetime.to_s)
        end

        it "should parse a new date_time_words from string with custom format" do 
            datetime = LesliDate::Formatter.new("1990/09/11 05:05", "%Y/%m/%d %H:%M").date_time_words
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.get).to eql(datetime.get)
            expect(LesliDate::Formatter.new(datetime.get).date_time_words.to_s).to eql(datetime.to_s)
        end
    ...
    describe "for database timestamps" do 
        ...
        it "should parse a new date for database timestamps" do 
            datetime = LesliDate::Formatter.new.date.db_timestamps
        ...
        it "should parse a new time for database timestamps" do 
            datetime = LesliDate::Formatter.new.time.db_timestamps
        ...
        it "should parse a new date_time for database timestamps" do 
            datetime = LesliDate::Formatter.new.date_time.db_timestamps
        ...
        it "should parse a new date_words for database timestamps" do 
            datetime = LesliDate::Formatter.new.date_words.db_timestamps
        ...
        it "should parse a new date_time_words for database timestamps" do 
            datetime = LesliDate::Formatter.new.date_time_words.db_timestamps
    ...
    describe "for database column" do 
        ...
        it "should parse a new date for database column" do 
            datetime = LesliDate::Formatter.new.date.db_column("deleted_at")
        ...
        it "should parse a new time for database column" do 
            datetime = LesliDate::Formatter.new.time.db_column("deleted_at")
        ...
        it "should parse a new date_time for database column" do 
            datetime = LesliDate::Formatter.new.date_time.db_column("deleted_at")
        ...
        it "should parse a new date_words for database column" do 
            datetime = LesliDate::Formatter.new.date_words.db_column("deleted_at")
        ...
        it "should parse a new date_time_words for database column" do 
            datetime = LesliDate::Formatter.new.date_time_words.db_column("deleted_at")
